...
<table width="100%" border="0" cellpadding="0" cellspacing="0" background="skin/images/frame/topbg.gif">
  <tr>
    <td width='20%' height="60"><img src="skin/images/frame/logo_student.gif" /></td>
    <td width='80%' align="right" valign="bottom">
    	<table width="750" border="0" cellspacing="0" cellpadding="0">
      <tr>
      <td align="right" height="26" style="padding-right:10px;line-height:26px;">
        	<c:if test="${empty student}">
        		[<a href="${pageContext.request.contextPath}/login.jsp" target="_parent">请登录</a>]
        	</c:if>
        	<c:if test="${not empty student}">
        		您好！${student.stuName}
        	</c:if>
        	[<a href="${pageContext.request.contextPath}/index.jsp" target="_parent">主页</a>]
        	[<a href="${pageContext.request.contextPath}/edit_user_pwd.jsp"  target="main">修改密码</a>]
        	[<a href="${pageContext.request.contextPath }/user?method=invalidate" target="_parsent">注销退出</a>]&nbsp;
      </td>
      </tr>
      <tr>
