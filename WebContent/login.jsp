...
<script type="text/javascript">
    ...
    function login(){
    	...
    	window.location="${pageContext.request.contextPath}/user?method=login&username="+username+"&password="+password;
    }
    function register(){
    	window.location="${pageContext.request.contextPath}/user?method=find_subject"	
    }
    function register_teach(){
    	window.location="${pageContext.request.contextPath}/login_teach.jsp";
    }
</script>
	<DIV>
	${msg}
			...
			<TBODY>
				...
				<TR>
					...
					<TD colSpan=4><IMG height=80 alt="" src="images/crm_9.gif"
						width=452 onclick="register_teach()" style="cursor:pointer;"></TD>
